...
import { DateHelper } from "../../utils/helpers/date_helper";
import { TextHelper } from "../../utils/helpers/text_helper";
        ...
        embeds: [
          {
            ...
            description: TextHelper.postProcessing(media!.description),
            ...
            fields: [
              ...
              },
              {
                ...
                value:
                  media!.startDate!.day +
                  " " +
                  DateHelper.getMonth(media!.startDate!.month) +
                  " " +
              ...
              },
              {
                ...
                value:
                  media!.endDate!.day +
                  " " +
                  DateHelper.getMonth(media!.endDate!.month) +
                  " " +
                  media!.endDate!.year,
                inline: true,
              },
  ...
  async pagination(
    ...
    if (error) {
      ...
      res.status(400).send({
        ...
        data: {
          content:
            "Next or Previoous page not avaiable",
        },
      });
      return;
    }
